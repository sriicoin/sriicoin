...
declare -A LIBS
LIBS[cli]="libsriicoin_cli.a"
LIBS[common]="libsriicoin_common.a"
LIBS[consensus]="libsriicoin_consensus.a"
LIBS[crypto]="libsriicoin_crypto.a"
LIBS[node]="libsriicoin_node.a"
LIBS[util]="libsriicoin_util.a"
LIBS[wallet]="libsriicoin_wallet.a"
...
# https://github.com/sriicoin/sriicoin/issues/10102
