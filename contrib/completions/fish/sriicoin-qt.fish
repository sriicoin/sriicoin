...
complete --command sriicoin-qt --no-files

# Extract options
function __fish_sriicoinqt_get_options
...
complete \
    --command sriicoin-qt \
    --arguments "(__fish_sriicoinqt_get_options --nofiles)"
