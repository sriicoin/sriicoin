...
# Extract options
function __fish_sriicoin_tx_get_options
...
# Extract commands
function __fish_sriicoin_tx_get_commands
...
complete \
    --command sriicoin-tx \
    --condition "not __fish_sriicoin_seen_cmd (__fish_sriicoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_sriicoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command sriicoin-tx \
    --arguments "(__fish_sriicoin_tx_get_commands)" \
    --no-files
