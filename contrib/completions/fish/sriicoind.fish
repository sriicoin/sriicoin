...
complete --command srriicoind --no-files

# Extract options
function __fish_sriicoind_get_options
...
complete \
    --command sriicoind \
    --arguments "(__fish_sriicoind_get_options --nofiles)"
